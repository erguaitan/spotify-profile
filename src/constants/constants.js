...
export const containerSectionClassMobile = "flex flex-col h-full px-3 py-7 overflow-auto gap-6";
export const headerTextSectionClass = "text-3xl font-bold";
export const headerTextSectionClassMobile = "text-2xl font-bold px-3";
